        ...
        <div class="container-fluid">
          <div class="row">
              <div class="col-lg-8">
                  <div class="panel panel-primary">
                      <div class="panel-heading">
                          <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Concours #1 </h3>
                      </div>
                      <div class="panel-body">
            						...
            						<div class="col-lg-6">
            							...
            							<p>
            							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque et finibus neque. Suspendisse finibus a quam in egestas. Nullam et nisl ut arcu sagittis cursus at ut mi. Morbi interdum odio vitae feugiat semper. Donec vestibulum tortor leo. Nam ipsum augue, ultricies non neque sed, facilisis cursus felis. Fusce rutrum neque risus, sed vehicula mauris rutrum non. Donec commodo ligula at est convallis vehicula. Duis molestie suscipit fringilla.
            							</p>
              ...
              <div class="col-lg-8">
                  <div class="panel panel-primary">
                      <div class="panel-heading">
                          <h3 class="panel-title"><i class="fa fa-bar-chart-o"></i> Concours #2 </h3>
                      </div>
                      <div class="panel-body">
            						<div class="col-lg-6">
            							<img src="http://placehold.it/350x315" class="img-responsive" alt="Responsive image">						
